lexicon = {
    "common": {
        ...
        'back_to_admin_panel': 'Вернуться в панель администратора',
    ...
    "admin": {
        ...
        'choose_prod_to_red': 'Выберите продукт, который вы хотели бы редактировать',
        'price_changed': 'Цена изменена <b>УСПЕШНО!</b>',
        'avail_changed': 'Наличие изменено <b>УСПЕШНО!</b>',
        'prod_deleted': 'Продукт <b>УДАЛЁН</b>',
        'admin_chat_new_order' : 'Новый заказ на сумму {} рублей от пользователя @{}. \n\n{} '
    },
    'menu_buttons': {
        "catalog_title": "🛍️ Каталог товаров",
        "cart_title": "🛒 Ваша корзина",
    ...
    'redact_product_btns':{
        'redact_price': '🏷️Редактировать цену',
        'redact_avail': 'Редактировать наличие',
        'del_prod': '❌Удалить товар'
    },
